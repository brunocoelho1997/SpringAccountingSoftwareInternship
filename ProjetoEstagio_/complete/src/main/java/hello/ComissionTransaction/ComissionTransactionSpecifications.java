...
public class ComissionTransactionSpecifications {



    public static Specification<ComissionTransaction> filterByType(Type type) {
    ...
    public static Specification<ComissionTransaction> filterByNameType(String nameType) {
        return (root, query, cb) -> {
            Predicate predicateFinal = null;
    ...
    public static Specification<ComissionTransaction> filterDeleletedEntities(Boolean deletedEntities) {
        return (root, query, cb) -> {
            Predicate predicateFinal = null;
    ...
    public static Specification<ComissionTransaction> filterExecuted(Boolean executed) {
        return (root, query, cb) -> {
            Predicate predicateFinal = null;
    ...
    public static Specification<ComissionTransaction> filter(String value, String frequency, Project project, Client client, String dateSince, String dateUntil, String valueSince, String valueUntil, Genre genre) {
        return (root, query, cb) -> {
            ...
            if(client != null)
            {
                predicateClient = cb.equal(root.get(ComissionTransaction_.client), client);
                if(predicateFinal!=null)
            ...
            if(project != null)
            {
                predicateProject = cb.equal(root.get(ComissionTransaction_.project), project);
                if(predicateFinal!=null)
