...
public class SaleTransactionSpecifications {
    public static Specification<SaleTransaction> filter(String value, String frequency, String type, String subType, String dateSince, String dateUntil, String valueSince, String valueUntil, Genre genre) {
