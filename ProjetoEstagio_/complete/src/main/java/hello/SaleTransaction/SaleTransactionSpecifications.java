...
import hello.Type.TypeSpecifications;
...
public class SaleTransactionSpecifications {

    public static Specification<SaleTransaction> filterByType(Type type) {
    ...
    public static Specification<SaleTransaction> filterByNameType(String nameType) {
        return (root, query, cb) -> {
            Predicate predicateFinal = null;
    ...
    public static Specification<SaleTransaction> filterDeleletedEntities(Boolean deletedEntities) {
        return (root, query, cb) -> {
            Predicate predicateFinal = null;
    ...
    public static Specification<SaleTransaction> filterExecuted(Boolean executed) {
        return (root, query, cb) -> {
            Predicate predicateFinal = null;
    ...
    public static Specification<SaleTransaction> filter(String value, String frequency, String dateSince, String dateUntil, String valueSince, String valueUntil, Genre genre) {
        return (root, query, cb) -> {
