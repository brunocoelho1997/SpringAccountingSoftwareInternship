...
public class SheetTransactionsSpecifications {
    public static Specification<SheetTransaction> filter(String value, String frequency, Type type, SubType subType, Employee employee, String dateSince, String dateUntil, String valueSince, String valueUntil, Genre genre) {
        return (root, query, cb) -> {
            ...
            if(employee != null)
            {
                predicateProject = cb.equal(root.get(SheetTransaction_.employee), employee);
                if(predicateFinal!=null)
