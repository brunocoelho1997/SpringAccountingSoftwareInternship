...
public class EmployeeTransactionSpecifications {
    ...
    public static Specification<EmployeeTransaction> filter(String value, String frequency, Type type, SubType subType, Project project, Employee employee, String dateSince, String dateUntil, String valueSince, String valueUntil, Genre genre) {
        return (root, query, cb) -> {
            ...
            if(project != null)
            {
                predicateProject = cb.equal(root.get(EmployeeTransaction_.project), project);
                if(predicateFinal!=null)
